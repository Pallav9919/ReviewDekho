...
class _ReviewFormState extends State<ReviewForm> {
  ...
  void getreataurant() async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    ScreenArguments.res = Restaurant(
        addressLine1: prefs.getString('restaurant_al1'),
        addressLine2: prefs.getString('restaurant_al2'),
        city: prefs.getString('restaurant_city'),
        id: prefs.getString('restaurant_id'),
        imgs: prefs.getString('restaurant_imgs'),
        mailid: prefs.getString('restaurant_mailid'),
        name: prefs.getString('restaurant_name'),
        phoneNo: prefs.getString('restaurant_phoneNo'),
        review: prefs.getString('restaurant_review'),
        reviewCount: prefs.getString('restaurant_reviewCount'));
    tag = prefs.getString('tag');
    setState(() {
      ScreenArguments.res.review = ScreenArguments.res.review;
    });
    getImages();
  }
